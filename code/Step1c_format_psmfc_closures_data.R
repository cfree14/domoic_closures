...
data_orig <- readxl::read_excel(file.path(indir, "OR-WA fisheries closures.xlsx"), sheet="PSMFC_DungCrab")
...
# Export
saveRDS(wa_dcrabs_comm, file=file.path(outdir, "PSMFC_2005_2024_comm_dcrab_closures.Rds"))
